...
let bdg = {
    ...
    saveIncome: ()=>{
        ...
        if (bdg.fIncomeID.value == "") bdg.entries.push(data); // Add new income entry
        else bdg.entries[parseInt(bdg.fIncomeID.value)] = data; // Update existing income entry
    ...
    saveExpense: ()=>{
        ...
        if (bdg.fExpenseID.value == "") bdg.entries.push(data); // Add new expense entry
        else bdg.entries[parseInt(bdg.fExpenseID.value)] = data; // Update existing expense entry
